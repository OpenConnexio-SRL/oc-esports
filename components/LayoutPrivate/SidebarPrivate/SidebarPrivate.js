...
const secondaryNavigation = [
    { name: 'Settings', href: '/private/profile', icon: CogIcon },
...
const SidebarPrivate = () => {
    ...
    return(
        <>
                        ...
                        <div className="space-y-1 px-2">
                            {navigation.map((item) => (
                                <a
                                    ...
                                    href={item.href}
                                    className={classNames(
                                        routing.asPath === item.href ? 'bg-cyan-800 text-white' : 'text-cyan-100 hover:text-white hover:bg-cyan-600',
                            ...
                            <div className="space-y-1 px-2">
                                {secondaryNavigation.map((item) => (
                                    <a
                                        ...
                                        href={item.href}
                                        className={classNames(
                                            routing.asPath === item.href ? 'bg-cyan-800 text-white' : 'text-cyan-100 hover:text-white hover:bg-cyan-600','group flex items-center rounded-md px-2 py-2 text-sm font-medium leading-6 text-cyan-100 hover:bg-cyan-600 hover:text-white'
                                        )}
                                    >
                                        <item.icon className="mr-4 h-6 w-6 text-cyan-200" aria-hidden="true" />
                                        {item.name}
            ...
            <div className="flex flex-1 flex-col mx-auto max-w-full lg:pl-64">
                <div className="flex h-16 flex-shrink-0 border-b border-gray-200 bg-white lg:border-none ">
                    ...
                    {/* Search bar */}
                    <div className="flex flex-1 justify-between px-64 sm:px-6 lg:mx-auto lg:max-w-full ">
            ...
            <div className="bg-white shadow">
                <div className="px-4 sm:px-6 lg:mx-auto lg:max-w-full">
